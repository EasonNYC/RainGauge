...
MqttMessageQueue mqtt_queue(MQTT_QUEUE_LENGTH);  // max 10 messages
...
//sensors
battery my_battery(BATTERY_PIN, &pub, &mqtt_queue, "backyard/test/");
Raingauge rain_gauge(RAIN_PIN, &pub,&mqtt_queue,"backyard/test/");
Tempsensor temp_sensor(GND_TMP_PIN, &pub,&mqtt_queue,"backyard/test/");
bmp280sensor bmp_sensor(&pub,&mqtt_queue,"backyard/test/");
